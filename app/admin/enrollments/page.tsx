...
import { ArrowLeft, Download, Search, GraduationCap, User, Calendar, DollarSign, CreditCard, FileText, Filter, RefreshCw, TrendingUp } from 'lucide-react';
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 hidden sm:block">Manage course enrollments</p>
                  </div>
                </div>
              </div>
            </div>
